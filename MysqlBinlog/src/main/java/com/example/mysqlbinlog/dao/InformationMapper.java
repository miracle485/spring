...
public interface InformationMapper {
    @Select("select COLUMN_NAME, ORDINAL_POSITION,TABLE_NAME from information_schema.columns where table_name = #{tableName}")
    @Results({
    ...
    @Select("<script>select COLUMN_NAME, ORDINAL_POSITION,TABLE_NAME from  information_schema.columns where table_name in " +
